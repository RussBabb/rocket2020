...
%     x_hat(11,i) = x(14,i) - delx(10,i);             %Rocket mass
    x_hat(11:13,i) = x(15:17,i) - delx(10:12,i);    %Accelerometer bias
    x_hat(14:16,i) = x(18:20,i) - delx(13:15,i);    %Gyroscope bias
    x_hat(17,i) = x(21,i) - delx(16,i);             %Altimeter bias
    x_hat(18,i) = x(22,i) - delx(17,i);             %Airspeed bias
