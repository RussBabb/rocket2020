...
[n, ~, ~] = size(errors);
hfigs = zeros(n,1);
ylabels = {'X Rocket Position Estimate Error (m)',...
    'Y Rocket Position Estimate Error (m)',...
    'Z Rocket Position Estimate Error (m)',...
    'X Rocket Velocity Estimate Error (m/s)',...
    'Y Rocket Velocity Estimate Error (m/s)',...
    'Z Rocket Velocity Estimate Error (m/s)',...
    'X Rocket Attitude Estimate Error (rad)',...
    'Y Rocket Attitude Estimate Error (rad)',...
    'Z Rocket Attitude Estimate Error (rad)',...
    'X Accel Bias Estimate Error (m/s^2)',...
    'Y Accel Bias Estimate Error (m/s^2)',...
    'Z Accel Bias Estimate Error (m/s^2)',...
    'X Gyro Bias Estimate Error (rad/s)',...
    'Y Gyro Bias Estimate Error (rad/s)',...
    'Z Gyro Bias Estimate Error (rad/s)',...
    'Altimeter Bias Estimate Error (m)',...
    'Airspeed Bias Estimate Error (m/s)',...
    };
...
for i=1:n
    ...
    h_hair = stairs(traj.time_nav, ensemble,'Color',[0.8 0.8 0.8]);
